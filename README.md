...
**Машинное обучение:**
- [Машинное обучение](images/machine_learning.png) (PNG - 11.7 MB): Линейная регрессия (Ridge, Lasso), Вероятностная трактовка линейной регрессии, Метод опорных векторов (SVM), Линейный дискриминантный анализ (LDA), Метод k ближайших соседей (k-NN), Метод ядерной оценки плотности (KDE), Метод парзеновского окна.