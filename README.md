...
**Машинное обучение:**
- [Машинное обучение](images/machine_learning.png) (PNG - 9 MB): Линейная регрессия (Ridge, Lasso), Вероятностная трактовка линейной регрессии, Метод опорных векторов (SVM), Линейный дискриминантный анализ (LDA).