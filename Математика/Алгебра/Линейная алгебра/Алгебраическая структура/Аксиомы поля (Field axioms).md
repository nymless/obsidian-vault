[[Множество (Set)|Множество]] $F$ с введёнными на нём [[Алгебраическая операция (Operation)|алгебраическими операциями]] сложения и умножения называется [[Поле (Field)|полем]], если выполнены следующие **аксиомы**:
