[[Алгебраическая операция (Operation)|Алгебраическую операцию]] $*$ называют **ассоциативной**, если для любых трёх элементов $a$, $b$, $c$ рассматриваемого множества выполняется равенство $(a*b)*c=a*(b*c)$.
