...
Так как $L_1$-регуляризация является не строго выпуклым функционалом, то существует вероятность, что подпространство решений совпадёт с подпространством признаков. В таком случае решений окажется бесконечное множество, и полученная модель не будет иметь обобщающей способности.