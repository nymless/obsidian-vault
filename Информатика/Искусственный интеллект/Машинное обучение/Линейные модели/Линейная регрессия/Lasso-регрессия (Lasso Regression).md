...
Так как $L_1$-регуляризация является **не строго выпуклым** функционалом, то существует вероятность, что подпространство решений совпадёт с подпространством признаков. В таком случае, в терминах [[Линейная алгебра (Linear algebra)|линейной алгебры]], система окажется [[Определённая и неопределённая система (Linear system with a single solution and Undeterminated system)|неопределённой]] и решений окажется бесконечное множество. Полученная модель не будет обладать предсказательной способностью.